...
export default function Filter(){
    ...
    return <div className="border border-primary-800 flex">
        ...
        <Button filter='small' handleFilter={handleFilter} activeFilter={activeFilter}>1&mdash;2</Button>
        <Button filter='medium' handleFilter={handleFilter} activeFilter={activeFilter}>3&mdash;4</Button>
        <Button filter='large' handleFilter={handleFilter} activeFilter={activeFilter}>5 and above</Button>
    </div>
}
