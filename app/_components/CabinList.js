...
export default async function CabinList({filter}){
    // noStore();
     ...
     if(filter==="medium") displayedCabins = cabins.filter((cabin)=>cabin.maxCapacity>=3&&cabin.maxCapacity<=4);
     if(filter==="large") displayedCabins = cabins.filter((cabin)=>cabin.maxCapacity>=5);
